...
class DiaInhabilView extends StatelessWidget {
  ...
  DiaInhabilView({
    super.key,
    this.ciclo = '2024 - 1 Primavera Test',
  });
            ...
            Row(
              ...
              children: [
                ElevatedButton(
                  ...
                  onPressed: () async {
                    final doc =
                        await firestore.collection('ciclos').doc(ciclo).get();
                    ...
                    if (!doc.exists) {
                      ...
                      if (!diasInhabiles.contains(Timestamp.now())) {
                        await firestore.collection('ciclos').doc(ciclo).update({
                          'dias_inhabiles':
            ...
            StreamBuilder<DocumentSnapshot>(
              ...
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                  ...
                  final List<Timestamp> diasInhabiles = List<Timestamp>.from(
                            ...
                            trailing: IconButton(
                              ...
                              onPressed: () async {
                                await firestore
                                    ...
                                    .doc(ciclo)
                                    .update({
                                  'dias_inhabiles': FieldValue.arrayRemove([e]),
                                });
                              },
                            ),
                          ),
