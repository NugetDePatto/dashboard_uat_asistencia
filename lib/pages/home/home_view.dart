...
import 'package:dashboard_uat_asistencia/pages/home/home_controller.dart';
import 'package:dashboard_uat_asistencia/zold/controllers/archivo_controller.dart';
import 'package:dashboard_uat_asistencia/zold/controllers/firestore_controller.dart';
import 'package:dashboard_uat_asistencia/zold/controllers/storage_controller.dart';
import 'package:dashboard_uat_asistencia/zold/views/dialogo_reporte_view.dart';
          ...
          child: Column(
            children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ElevatedButton.icon(
                          ...
                          onPressed: controller.crearReporte,
                        ...
                        ElevatedButton.icon(
                          onPressed: archivoController.profesoresMapa.isEmpty
                              ...
                              : () async {
                                  ...
                                  var profesores =
                                      archivoController.profesoresMapa;
              ...
              ElevatedButton(
                onPressed: () async {
                  // var asistio =
                  //     await AsistenciasController().asistioProfesorMateria(
                  //   ciclo,
                  ...
                  // print('Asistio: $asistio');

                  // PDFServices pdfServices = PDFServices();

                  // var pdf = pdfServices.crearPdf( );

                  // pdfServices.guardarPDF(pdf);
                },
